    ...
    <main className="relative min-h-screen overflow-hidden bg-[#03050b] text-white">
      ...
      <style jsx global>{`
        ...
        .fitra-line {
          ...
          stroke-dashoffset: 620;
          animation: fitra-pulse-line 1.8s ease-out forwards;
        }

        .fitra-bar {
          transform-origin: bottom;
          animation: fitra-bar-grow 900ms ease-out forwards;
        }

        .fitra-float {
          animation: fitra-float 5s ease-in-out infinite;
        }
      `}</style>
    </main>
  );
