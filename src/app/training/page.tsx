...
#FITRA #筋トレ記録 #ボディメイク`;
  ...
  return (
    <AuthGuard>
      <AppHeader />
      <div className="pt-16">
        <main className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-red-950 px-4 py-8 text-white sm:px-6 sm:py-12">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <section>
          ...
          <h1 className="mb-2 text-3xl font-black tracking-tight text-red-300 md:text-5xl">
            トレーニング分析
          </h1>

          <p className="text-zinc-400">
            リアルタイム記録、AI分析、成長推移をまとめて確認します。
          </p>
        </section>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <LoadingLink
            href="/training/live"
            theme="training"
            className="block cursor-pointer rounded-2xl border border-red-900 bg-zinc-900/90 p-6 shadow-lg shadow-black/30 transition hover:scale-[1.02] hover:border-red-500"
          >
            <h2 className="mb-2 text-xl font-semibold">リアルタイム記録</h2>

            <p className="mb-4 text-sm text-zinc-400">
              セットごとに即入力。ジム中に使う記録モードです。
            </p>

            <span className="text-sm text-red-400">今すぐ開始</span>
          </LoadingLink>

          <LoadingLink
            href="/training/normal/step1"
            theme="training"
            className="block cursor-pointer rounded-2xl border border-zinc-800 bg-zinc-900/90 p-6 shadow-lg shadow-black/30 transition hover:scale-[1.02] hover:border-red-500"
          >
            <h2 className="mb-2 text-xl font-semibold">分析・振り返り</h2>

            <p className="mb-4 text-sm text-zinc-400">
              トレーニングをまとめて入力して、AI分析を行います。
            </p>

            <span className="text-sm text-red-400">分析を始める</span>
          </LoadingLink>
        </section>
